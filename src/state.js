...
const PRODUCTS = [
  ...
  {id:4, name:'SIGNAL TRACK JACKET', price:55000, oldPrice:null, cat:'camperas', badge:'NUEVO', desc:'Campera track con detalles violeta. Tela técnica anti-viento. Diseño exclusivo.', sizes:['S','M','L'], colors:['negro','violeta'], stock:12, sku:'XNC-CAM-004', rating:4.7, reviews:11, img:'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=600&q=80', images:['https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=600&q=80','https://images.unsplash.com/photo-1556821840-3a63f15732ce?w=600&q=80'], tags:['newdrops','stylo']},
